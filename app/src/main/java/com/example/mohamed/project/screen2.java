        ...
        newaccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Email.equals("") || Password.equals("") || Fname.equals("") || Lname.equals("")) {
                    Toast.makeText(screen2.this, "No Data", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, SIGNUP_URL,
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (!responseMessage[0].equals("1")) {
                                        Toast.makeText(screen2.this, "Login Error " + response, Toast.LENGTH_LONG).show();
                                        ResetLogin();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(screen2.this, error.toString(), Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                    }
                }) {
